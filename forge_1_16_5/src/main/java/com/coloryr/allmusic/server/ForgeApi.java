...
public class ForgeApi {
    public static void sendMessageRun(CommandSource obj, String message, String end, String command) {
    ...
    public static void sendMessageSuggest(CommandSource obj, String message, String end, String command) {
        StringTextComponent send = new StringTextComponent(message);
        StringTextComponent endtext = new StringTextComponent(end);
