...
public class CommandHelp extends ACommand {
    ...
    public void execute(Object sender, String name, String[] args) {
        ...
        AllMusic.side.sendMessage(sender, AllMusic.miniMessage(AllMusic.getMessage().help.normal.hud11)
                .append(AllMusic.miniMessageSuggest(AllMusic.getMessage().click.clickCheck, "/music hud ")));
        AllMusic.side.sendMessage(sender, AllMusic.miniMessage(AllMusic.getMessage().help.normal.hud12)
                .append(AllMusic.miniMessageSuggest(AllMusic.getMessage().click.clickCheck, "/music hud ")));
        AllMusic.side.sendMessage(sender, AllMusic.miniMessage(AllMusic.getMessage().help.normal.hud13)
                .append(AllMusic.miniMessageSuggest(AllMusic.getMessage().click.clickCheck, "/music hud ")));
        AllMusic.side.sendMessage(sender, AllMusic.miniMessage(AllMusic.getMessage().help.normal.hud14)
                .append(AllMusic.miniMessageSuggest(AllMusic.getMessage().click.clickCheck, "/music hud ")));
