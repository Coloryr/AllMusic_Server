...
public class HttpGet {
    ...
    public static Res realData(String path, String data,String cookie) {
        try {
            data = URLEncoder.encode(data, "UTF-8");
            org.apache.http.client.methods.HttpGet get = new org.apache.http.client.methods.HttpGet(path + data);
            get.setConfig(defaultConfig);
    ...
    private static Res getRes(org.apache.http.client.methods.HttpGet get) throws IOException {
